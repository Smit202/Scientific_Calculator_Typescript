...
format.addEventListener('mouseup', (event) => {
    const target = event.target;
...
memory.addEventListener('mouseup', (event) => {
    const target = event.target;
    target.style.backgroundColor = '#F3F3F3';
});
historyDisplay.addEventListener('mousedown', (event) => {
    const target = event.target;
    let id;
    if (target.className == 'histObject')
        id = target.parentElement.id;
    else
        id = target.id;
    document.getElementById(id).style.backgroundColor = '#DDDDDD';
});
historyDisplay.addEventListener('mouseup', (event) => {
    const target = event.target;
    let id;
    if (target.className == 'histObject')
        id = target.parentElement.id;
...
operations.addEventListener("click", (event) => {
    ...
    if (target.tagName == "svg")
        ...
        id = target.parentElement.parentElement.id;
    else if (target.tagName == "sup")
        id = target.parentElement.id;
    else if (target.tagName == "sub")
        id = target.parentElement.id;
    else
        id = target.id;
    if (exparr.at(-1) == '=') {
    ...
    if (id == 'clear') {
        ...
        if (feFlag)
            input.value = Math.PI.toExponential();
        else
            input.value = Math.PI + '';
    }
    else if (id == 'e') {
        if (feFlag)
            input.value = Math.E.toExponential();
        else
            input.value = Math.E + '';
    }
    else if (id == 'exponential') {
        if (isNaN(+num))
            alert(`${num} is invalid number`);
        else
            input.value = (+num).toExponential();
        expression.value = exparr.join(' ');
    }
    else if (id == 'inverse') {
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (1 / +num).toExponential();
            else
                input.value = `${1 / +num}`;
            if (exparr.at(-1) == 'yroot')
                evalExparr.push(`1/${+input.value})`);
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.abs(+num).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = factorial(+num).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = ((+num) ** 2).toExponential();
            else
                input.value = `${(+num) ** 2}`;
            if (exparr.at(-1) == 'yroot')
                evalExparr.push(`1/${+input.value})`);
        ...
        if (isNaN(+num) || +num < 0) {
            ...
            if (feFlag)
                input.value = Math.sqrt(+num).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (10 ** (+num)).toExponential();
            else
                input.value = `${10 ** (+num)}`;
            if (exparr.at(-1) == 'yroot')
                evalExparr.push(`1/${+input.value})`);
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = ((+num) ** 3).toExponential();
            else
                input.value = `${(+num) ** 3}`;
            if (exparr.at(-1) == 'yroot')
                evalExparr.push(`1/${+input.value})`);
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.cbrt(+num).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (2 ** (+num)).toExponential();
            else
                input.value = `${2 ** (+num)}`;
            if (exparr.at(-1) == 'yroot')
                evalExparr.push(`1/${+input.value})`);
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.exp(+num).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.log10(+num).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.log(+num).toExponential();
            else
        ...
        if (parenthesisStack.length != 0) {
            ...
            alert('inavalid right parenthesis');
        expression.value = exparr.join(' ');
    }
    else if (id == 'mod') {
        if (isNaN(+num)) {
        ...
        expression.value = exparr.join(' ');
        if (feFlag)
            input.value = eval(evalExparr.join('')).toExponential();
        else
        ...
        else if (isNaN(+evalExparr.at(-1)) && exparr.at(-2) == num || isCleared)
            input.value = id;
        else
            input.value += id;
        if (+input.value != 0) {
...
trigFunctions.addEventListener('click', (event) => {
    ...
    if (angleFlag == 0)
        radAngle = degToRadian(+num);
    else if (angleFlag == 1)
        radAngle = +num;
    else
        radAngle = gradToRadian(+num);
    if (id == 'sin') {
        if (isNaN(+num)) {
            alert(`${num} is invalid`);
        }
            ...
            if (feFlag)
                input.value = Math.sin(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.cos(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.tan(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (1 / Math.cos(radAngle)).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (1 / Math.sin(radAngle)).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (1 / Math.tan(radAngle)).toExponential();
            else
    ...
    if (id == 'arcsin') {
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.asin(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.acos(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.atan(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.acos(1 / radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.asin(1 / radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.atan(1 / radAngle).toExponential();
            else
    ...
    if (id == 'sinh') {
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.sinh(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.cosh(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.tanh(radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (1 / Math.cosh(radAngle)).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (1 / Math.sinh(radAngle)).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = (1 / Math.tanh(radAngle)).toExponential();
            else
    ...
    if (id == 'arcsinh') {
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.asinh(+radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.acosh(+radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.atanh(+radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.acosh(1 / radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.asinh(1 / radAngle).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.atanh(1 / radAngle).toExponential();
            else
...
functionOperations.addEventListener('click', (event) => {
    ...
    if (id == 'abs') {
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.floor(+num).toExponential();
            else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = Math.ceil(+num).toExponential();
            else
        ...
        if (feFlag)
            input.value = Math.random().toExponential();
        else
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = dms(+num).toExponential();
            else
                input.value = dms(+num) + '';
            if (exparr.at(-1) == 'yroot')
                evalExparr.push(`1/${+input.value})`);
        ...
        if (isNaN(+num)) {
            ...
            if (feFlag)
                input.value = deg(+num).toExponential();
            else
                input.value = deg(+num) + '';
            if (exparr.at(-1) == 'yroot')
                evalExparr.push(`1/${+input.value})`);
...
memory.addEventListener('click', (event) => {
    ...
    else if (id == 'MR' && memoryFlag == 1)
        input.value = memoryArray[memoryLength - 1] + '';
    else if (id == 'M+') {
        if (memoryLength == 0)
            memoryArray.push(+num);
        else
            memoryArray[memoryLength - 1] += +num;
        memoryFlag = 1;
...
historyButton.addEventListener('click', () => {
    if (historyFlag == 0) {
        ...
        if (historyArray.length != 0) {
            ...
            let histExpStyle = Object.assign({}, histResultStyle);
...
function mouseUpAction(event) {
    ...
    if (['operations-item-number', 'trigFunc', 'normalFunc', 'memory'].includes(elem.className))
...
function dms(num) {
    ...
    if (Number.isInteger(+temp.toFixed(4)))
        return +(sign + deg + '.' + min);
    temp = (temp - +min) * 60;
    ...
    if (index <= numStr.length && index > 0)
        return +(sign + deg + '.' + min + sec + temp.toFixed(index - 2).toString().split('.')[1]);
    else if (temp.toString().length <= numStr.length)
        return +(sign + deg + '.' + min + sec + temp);
    else
        return +(sign + deg + '.' + min + sec + temp.toFixed(numStr.length - 2).toString().split('.')[1]);
}
function deg(num) {
